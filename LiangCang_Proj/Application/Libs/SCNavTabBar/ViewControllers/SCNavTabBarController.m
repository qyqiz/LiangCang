...
- (void)viewInit
{
    ...
    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, 0, SCREEN_WIDTH, SCREEN_HEIGHT - _navTabBar.frame.origin.y - _navTabBar.frame.size.height - STATUS_BAR_HEIGHT - NAVIGATION_BAR_HEIGHT)];
